...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, LucideSearch, LucideX, LucideSlidersHorizontal],
  template: `
    <section class="rounded-3xl border border-slate-200 bg-slate-50 p-4 shadow-sm md:p-6" [formGroup]="form">
      <div class="relative">
      ...
      <div class="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <button
          type="button"
          class="inline-flex items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          (click)="moreFiltersClick.emit()"
        >
          Más filtros
      ...
      <div class="mt-4 flex flex-wrap items-center gap-2 border-t border-slate-200 pt-4">
        ...
        <div class="ml-auto inline-flex items-center gap-2 text-sm">
