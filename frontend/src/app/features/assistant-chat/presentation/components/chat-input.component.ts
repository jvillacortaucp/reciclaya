...
@Component({
  ...
  template: `
    <form class="flex items-center gap-3" (ngSubmit)="submitted.emit()">
      ...
      <button
        type="submit"
        class="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-md transition hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-200 sm:h-14 sm:w-14 sm:rounded-2xl">
